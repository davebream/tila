...
describe("tila-sdk/local — optional peer dependency (R8)", () => {
  it("does NOT throw merely on import when better-sqlite3 is absent", async () => {
  ...
  it("throws the helpful error when better-sqlite3 cannot be loaded", async () => {
    vi.resetModules();
  ...
  it("throws the helpful error when the drizzle adapter cannot be loaded", async () => {
    vi.resetModules();
