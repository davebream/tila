class Tila < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/davebream/tila/releases/download/v0.2.6/tila-darwin-arm64"
      sha256 "7c9985ae21b795c8891f7a706fe07d7c264f519a252fdb70b7bdce184a561ff2"
    end
    on_intel do
      url "https://github.com/davebream/tila/releases/download/v0.2.6/tila-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/davebream/tila/releases/download/v0.2.6/tila-linux-arm64"
      sha256 "8368383145cc82cf41bc83b1547b6e06ecb8e4fed76114ab24b2c891e1c17faf"
    end
    on_intel do
      url "https://github.com/davebream/tila/releases/download/v0.2.6/tila-linux-x64"
